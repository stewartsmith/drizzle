...
select:
          select_init
          {
            ...
            lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SELECT, 
                                                          YYSession);
            if (lex->command == NULL)
              DRIZZLE_YYABORT;
          }
...
show_param:
           DATABASES show_wild
           {
             ...
             lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_DATABASES, 
                                                           YYSession);
             if (lex->command == NULL)
               DRIZZLE_YYABORT;
         ...
         | opt_full TABLES opt_db show_wild
           {
             ...
             lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_TABLES, 
                                                           YYSession);
             if (lex->command == NULL)
               DRIZZLE_YYABORT;
             lex->select_lex.db= $3;
         ...
         | TABLE_SYM STATUS_SYM opt_db show_wild
           {
             ...
             lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_TABLE_STATUS,
                                                           YYSession);
             if (lex->command == NULL)
               DRIZZLE_YYABORT;
             lex->select_lex.db= $3;
        ...
        | OPEN_SYM TABLES opt_db show_wild
          {
            ...
            lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_OPEN_TABLES,
                                                          YYSession);
            if (lex->command == NULL)
              DRIZZLE_YYABORT;
            lex->select_lex.db= $3;
        ...
        | opt_full COLUMNS from_or_in table_ident opt_db show_wild
          {
            ...
            lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_FIELDS,
                                                          YYSession);
            if (lex->command == NULL)
              DRIZZLE_YYABORT;
            if ($5)
        ...
        | keys_or_index from_or_in table_ident opt_db where_clause
          {
            ...
            lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_KEYS, 
                                                          YYSession);
            if (lex->command == NULL)
              DRIZZLE_YYABORT;
            if ($4)
        ...
        | opt_var_type STATUS_SYM show_wild
          {
            ...
            lex->command= new(std::nothrow) ShowStatus(SQLCOM_SHOW_STATUS,
                                                       YYSession,
                                                       &LOCK_status);
            if (lex->command == NULL)
              DRIZZLE_YYABORT;
        ...
        | opt_var_type  VARIABLES show_wild
          {
            ...
            lex->command= new(std::nothrow) DefaultSelect(SQLCOM_SHOW_VARIABLES, 
                                                          YYSession);
            if (lex->command == NULL)
              DRIZZLE_YYABORT;
            lex->option_type= $1;

...
const string ha_resolve_storage_engine_name(const drizzled::plugin::StorageEngine *engine)
{
...
{
  return drizzled::plugin::StorageEngine::findByName(session, find_str);
}

...
int check_user(Session *thd, const char *passwd, uint32_t passwd_len, const char *db, bool check_count);
pthread_handler_t handle_one_connection(void *arg);
bool init_new_connection_handler_thread();
void time_out_user_resource_limits(Session *thd, USER_CONN *uc);

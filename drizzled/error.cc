...
ErrorMap::ErrorMap()
{
  ...
  add(ER_USER_LOCKS_CANT_WAIT_ON_OWN_LOCK, N_("Session can not wait on a lock owned by the session."));
  add(ER_USER_LOCKS_NOT_OWNER_OF_LOCK, N_("Session does not own lock."));

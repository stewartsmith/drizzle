...
between the Drizzle kernel and appliers.  The Drizzle kernel sends replication
events, encoded as Google Buffer Protocol message, to every replicator.
Replicators implement specific behaviors by modifying or filtering
replication events before possiblying sending them to their paired appliers.

...
static DRIZZLE_THDVAR_BOOL(strict_mode,
  PLUGIN_VAR_NOCMDARG,
...
/*=====================*/
	...
	void*	thd __attribute__((unused)),		/* in: pointer to a MySQL THD object */
...
/*   BACKGROUND INFO: HOW THE DRIZZLE QUERY CACHE WORKS WITH INNODB
     ------------------------------------------------------------
...
/*======================================*/
	...
	uint64_t *)	/* unused for this engine */
{
	ibool	is_autocommit;
	trx_t*	trx;
	char	norm_name[1000];
...
/*============================*/
	trx_t*,		/* in: transaction which modifies the table */
	char*,	/* in: concatenation of database name, null
				char '\0', table name, null char'\0';
				NOTE that in Windows this is always
				in LOWER CASE! */
	ulint)	/* in: full name length where also the null
				chars count */
{
...
/*===========*/
	row_prebuilt_t*	prebuilt,	/* in/out: prebuilt struct */
	THD*		,		/* in: current user thread, used
...
/*=========================================*/
						...
						error code */
        uint64_t*	value)			/* out: the autoinc value */
{
	uint64_t	auto_inc;
	ibool		stmt_start;
	int		mysql_error = 0;

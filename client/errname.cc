    ...
    error_code_map()
{
  ...
  st_error_names[]=
  {
    ...
    { "ER_UNKNOWN_TEMPORAL_TYPE",1682 },
    { "ER_INVALID_STRING_FORMAT_FOR_DATE",1683 },
    { "ER_INVALID_STRING_FORMAT_FOR_TIME",1684 },
    { "ER_INVALID_UNIX_TIMESTAMP_VALUE",1685 },
    { "ER_INVALID_DATETIME_VALUE",1686 },
    { "ER_INVALID_NULL_ARGUMENT",1687 },
    { "ER_INVALID_NEGATIVE_ARGUMENT",1688 },
    { "ER_ARGUMENT_OUT_OF_RANGE",1689 },
    { "ER_INVALID_TIME_VALUE",1690 },
    ...
    { "ER_CARTESIAN_JOIN_ATTEMPTED", 1702},
    { 0, 0 }
  };

...
extern "C" void process_request(evhtp_request_t *req, void* );
extern "C" void process_root_request(evhtp_request_t *req, void* );/*
...
public:
  ...
  bool init()
  {
    ...
    if ((httpd= evhtp_new(base,NULL)) == NULL)
    {
    ...
    if ((evhtp_bind_socket(httpd, "0.0.0.0", getPort(),1024)) == -1)
    {
    ...
    evhtp_set_cb(httpd, "/", process_root_request, NULL);
  /*// API 0.1
    evhtp_set_cb(httpd, "/0.1/version", process_api01_version_req, NULL);
    evhtp_set_cb(httpd, "/0.1/sql", process_api01_sql_req, NULL);
    // API 0.2
    evhtp_set_cb(httpd, "/0.2/version", process_api01_version_req, NULL);
    evhtp_set_cb(httpd, "/0.2/sql", process_api01_sql_req, NULL);
    evhtp_set_cb(httpd, "/0.2/json", process_api02_json_req, NULL);
    // API "latest" and also available in top level
    evhtp_set_cb(httpd, "/latest/version", process_api01_version_req, NULL);
    evhtp_set_cb(httpd, "/latest/sql", process_api01_sql_req, NULL);
    evhtp_set_cb(httpd, "/latest/json", process_api02_json_req, NULL);
    evhtp_set_cb(httpd, "/version", process_api01_version_req, NULL);
    evhtp_set_cb(httpd, "/sql", process_api01_sql_req, NULL);
    evhtp_set_cb(httpd, "/json", process_api02_json_req, NULL);    

...
#ifndef PLUGIN_INFO_SCHEMA_MODULES_H
#define PLUGIN_INFO_SCHEMA_MODULES_H
...
{
  /**
   * Create the various columns for the MODULES I_S table and add them
   * to the std::vector of columns for the MODULES table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_MODULES_H */

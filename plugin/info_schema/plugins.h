...
#ifndef PLUGIN_INFO_SCHEMA_PLUGINS_H
#define PLUGIN_INFO_SCHEMA_PLUGINS_H
...
{
  /**
   * Create the various columns for the PLUGINS I_S table and add them
   * to the std::vector of columns for the PLUGINS table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_PLUGINS_H */

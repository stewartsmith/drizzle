...
#ifndef PLUGIN_INFO_SCHEMA_PROCESSLIST_H
#define PLUGIN_INFO_SCHEMA_PROCESSLIST_H
...
{
  /**
   * Create the various columns for the PROCESSLIST I_S table and add them
...
#endif /* PLUGIN_INFO_SCHEMA_PROCESSLIST_H */

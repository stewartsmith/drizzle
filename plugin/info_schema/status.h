...
#ifndef PLUGIN_INFO_SCHEMA_STATUS_H
#define PLUGIN_INFO_SCHEMA_STATUS_H
...
class GlobalStatusIS
{
  /**
   * Create the various columns for the GLOBAL_STATUS I_S table and add them
   * to the std::vector of columns for the GLOBAL_STATUS table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_STATUS_H */

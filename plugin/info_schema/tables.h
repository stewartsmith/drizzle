...
#ifndef PLUGIN_INFO_SCHEMA_TABLES_H
#define PLUGIN_INFO_SCHEMA_TABLES_H
...
{
  /**
   * Create the various columns for the TABLES I_S table and add them
   * to the std::vector of columns for the TABLES table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_TABLES_H */

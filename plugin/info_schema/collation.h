...
#ifndef PLUGIN_INFO_SCHEMA_COLLATION_H
#define PLUGIN_INFO_SCHEMA_COLLATION_H
...
{
  /**
   * Create the various columns for the COLLATION I_S table and add them
   * to the std::vector of columns for the COLLATION table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_COLLATION_H */

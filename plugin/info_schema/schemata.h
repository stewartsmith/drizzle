...
#ifndef PLUGIN_INFO_SCHEMA_SCHEMATA_H
#define PLUGIN_INFO_SCHEMA_SCHEMATA_H
...
{
  /**
   * Create the various columns for the SCHEMATA I_S table and add them
   * to the std::vector of columns for the SCHEMATA table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_SCHEMATA_H */

...
#ifndef PLUGIN_INFO_SCHEMA_COLLATION_CHAR_SET_H
#define PLUGIN_INFO_SCHEMA_COLLATION_CHAR_SET_H
...
class CollationCharSetIS
{
  /**
   * Create the various columns for the COLLATION_CHAR_SET I_S table and add them
   * to the std::vector of columns for the COLLATION_CHAR_SET table.
   *
...
#endif /* PLUGIN_INFO_SCHEMA_COLLATION_CHAR_SET_H */

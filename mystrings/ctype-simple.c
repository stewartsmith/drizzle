...
int my_strnncollsp_simple(const CHARSET_INFO * cs, const uchar *a, size_t a_length, 
...
int64_t my_strntoll_8bit(const CHARSET_INFO *cs __attribute__((unused)),
			  const char *nptr, size_t l, int base,
			  char **endptr,int *err)
{
  int negative;
...
uint64_t my_strntoull_8bit(const CHARSET_INFO *cs,
			   const char *nptr, size_t l, int base,
			   char **endptr, int *err)
{
  int negative;
...
size_t my_int64_t10_to_str_8bit(const CHARSET_INFO *cs __attribute__((unused)),
...
int64_t my_strtoll10_8bit(const CHARSET_INFO *cs __attribute__((unused)),

...
static uint mbcharlen_eucjpms(const CHARSET_INFO *cs __attribute__((unused)),uint c)
{
...
static
size_t my_well_formed_len_eucjpms(const CHARSET_INFO *cs __attribute__((unused)),

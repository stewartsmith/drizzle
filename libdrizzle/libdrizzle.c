...
static my_bool drizzle_client_init= 0;
static my_bool org_my_init_done= 0;


/*
  Initialize the DRIZZLE client library
  ...
  NOTES
    ...
    It's called by drizzle_init() to ensure that things will work for
    old not threaded applications that doesn't call drizzle_server_init()
    directly.
...
int STDCALL drizzle_server_init(int argc __attribute__((unused)),

...
enum_monotonicity_info Item_func_to_days::get_monotonicity_info() const
{
  ...
  {
    if (args[0]->field_type() == FIELD_TYPE_NEWDATE)
      return MONOTONIC_STRICT_INCREASING;
    if (args[0]->field_type() == FIELD_TYPE_DATETIME)
...
{
  if (args[0]->type() == Item::FIELD_ITEM &&
      (args[0]->field_type() == FIELD_TYPE_NEWDATE ||
       args[0]->field_type() == FIELD_TYPE_DATETIME))
    return MONOTONIC_INCREASING;
  return NON_MONOTONIC;
}
...
void Item_date_add_interval::fix_length_and_dec()
{
  ...
  /*
    ...
    - If first arg is a FIELD_TYPE_DATETIME result is FIELD_TYPE_DATETIME
    - If first arg is a FIELD_TYPE_NEWDATE and the interval type uses hours,
      minutes or seconds then type is FIELD_TYPE_DATETIME.
    - Otherwise the result is FIELD_TYPE_STRING
      (This is because you can't know if the string contains a DATE, MYSQL_TIME or
      DATETIME argument)
  */
  cached_field_type= FIELD_TYPE_STRING;
  arg0_field_type= args[0]->field_type();
  if (arg0_field_type == FIELD_TYPE_DATETIME ||
      arg0_field_type == FIELD_TYPE_TIMESTAMP)
    cached_field_type= FIELD_TYPE_DATETIME;
  else if (arg0_field_type == FIELD_TYPE_NEWDATE)
  {
...
void Item_func_add_time::fix_length_and_dec()
{
  ...
  /*
    ...
    - If first arg is a FIELD_TYPE_DATETIME or FIELD_TYPE_TIMESTAMP 
      result is FIELD_TYPE_DATETIME
    - If first arg is a FIELD_TYPE_TIME result is FIELD_TYPE_TIME
    - Otherwise the result is FIELD_TYPE_STRING
  */

  cached_field_type= FIELD_TYPE_STRING;
  arg0_field_type= args[0]->field_type();
  if (arg0_field_type == FIELD_TYPE_NEWDATE ||
      arg0_field_type == FIELD_TYPE_DATETIME ||
      arg0_field_type == FIELD_TYPE_TIMESTAMP)
    cached_field_type= FIELD_TYPE_DATETIME;
  else if (arg0_field_type == FIELD_TYPE_TIME)
    cached_field_type= FIELD_TYPE_TIME;
}
  ...
  if ((const_item= args[1]->const_item()))
  {
    ...
    if (!args[1]->null_value)
    {
      ...
      case DATE_ONLY:
        ...
        cached_field_type= FIELD_TYPE_NEWDATE; 
        max_length= MAX_DATE_WIDTH * MY_CHARSET_BIN_MB_MAXLEN;
        break;
      case TIME_ONLY:
      case TIME_MICROSECOND:

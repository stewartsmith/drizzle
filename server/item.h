...
public:
  ...
  enum_field_types field_type() const   { return FIELD_TYPE_NULL; }
...
public:
  ...
  */
  ...
  /*
    ...
    For example in case of 'SELECT ?' you'll get FIELD_TYPE_STRING both
...
public:
  ...
  */
  ...
  int save_in_field(Field *field, bool no_conversions);
  enum Item_result result_type () const { return STRING_RESULT; }
  enum_field_types field_type() const { return FIELD_TYPE_VARCHAR; }
  bool basic_const_item() const { return 1; }
  bool eq(const Item *item, bool binary_cmp) const;
  Item *clone_item() 
  {
...
public:
  ...
  enum_field_types field_type() const { return FIELD_TYPE_BLOB; }
};
...
public:
  Item_cache(): 
    example(0), used_table_map(0), cached_field(0), cached_field_type(FIELD_TYPE_STRING) 
  {
    fixed= 1; 
    null_value= 1;
  }
